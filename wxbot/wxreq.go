...
func (r *wxReq) Verify(toUserName, ticket string) ([]byte, error) {
  ...
  dump("Verify_"+times.NowStrf(times.DateTimeMsFormat5), body)
  return body, nil
}
...
func (r *wxReq) Remark(toUserName, remark string) ([]byte, error) {
  ...
  dump("Remark_"+times.NowStrf(times.DateTimeMsFormat5), body)
  return body, nil
}
...
func (r *wxReq) GetContacts(toUserNames ...string) ([]byte, error) {
  ...
  dump("GetContacts_"+times.NowStrf(times.DateTimeMsFormat5), body)
  return body, nil
}
...
func (r *wxReq) SignOut() ([]byte, error) {
  ...
  dump("SignOut_"+times.NowStrf(times.DateTimeMsFormat5), body)
  return body, nil
}
...
func (r *wxReq) SendText(toUserName, text string) ([]byte, error) {
  ...
  dump("SendText_"+times.NowStrf(times.DateTimeMsFormat5), body)
  return body, nil
}
...
func (r *wxReq) SendMedia(toUserName, mediaId string, msgType int, sendUrlPath string) ([]byte, error) {
  ...
  dump("SendMedia_"+times.NowStrf(times.DateTimeMsFormat5), body)
  return body, nil
}
...
func (r *wxReq) uploadChunk(info *uploadInfo) (string, error) {
  ...
  dump("uploadChunk_"+times.NowStrf(times.DateTimeMsFormat5), body)
